//
// Created by rmaks on 12.06.2023.
//

#ifndef EVENT_BUTTON_ASYNCOTAUPDATE_H
#define EVENT_BUTTON_ASYNCOTAUPDATE_H
...
public:
    ...
    void begin(AsyncWebServer *server, const char* username = "", const char* password = ""){
        ...
        _server->on("/update/identity", HTTP_GET, [&](AsyncWebServerRequest *request){
            ...
            request->send(200, "application/json", "{\"id\": \""+_id+"\", \"firmware\": \"" + _firmware + "\"}");
...
#endif //EVENT_BUTTON_ASYNCOTAUPDATE_H

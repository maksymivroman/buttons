...
<div class="content">
    ...
    <div class="modal" id="editor">
        ...
        <h5 style="color: #b9b9b9; margin: 10px 0;">If you want to use JSON as event data please use escape characters '\"'</h5>
        <h5 style="color: #91a9ff;"> Example:   "{\"eventName\":\"DYNAMIC_EVENT\",\"eventData\":[{\"name\":\"user_check\",\"value\":\"yes\"}]}"</h5>
